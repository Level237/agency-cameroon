...
export default function Header() {
  return (
   <header className="w-[100%] sticky  z-[30] bg-transparent backdrop-blur   border-b-[0.1px] border-[#e8d1bb38] top-0  py-4 px-4 sm:px-10 dark:bg-[#000]  bg-[#e8d1bb]  font-[sans-serif] min-h-[60px]">
